...
class SawyerReachAboveGenV2Policy():
    def __init__(self, skill='reach above', target_object='milk'):
        self.stage = 0
        ...
        if target_object == 'bottle':
            self.action_list.append(MoveTo(self.target_func_place_z, 'gripper_open', error_limit=0.01, time_limit=100))
