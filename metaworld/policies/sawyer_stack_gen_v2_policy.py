...
class SawyerStackGenV2Policy():
    def __init__(self, skill='Stack', target_object='blockA'):
        self.stage = 0
        ...
        if target_object != 'bottle' and target_object != 'milk':
            self.action_list.append(MoveTo(self.target_func_above_target_move_down, 'gripper_open', error_limit=0.01, time_limit=200))
            ...
            self.action_list.append(MoveTo(self.target_func_above_target_move_down_bottle, 'gripper_open', error_limit=0.01, time_limit=200))
            ...
            self.action_list.append(MoveTo(self.target_func_above_target_move_down_milk, 'gripper_open', error_limit=0.01, time_limit=200))
            self.action_list.append(MoveTo(self.target_func_above_target_move_down_milk, 'gripper_close', time_limit=20))
        self.action_list.append(MoveTo(self.target_func_above_target, 'gripper_close', error_limit=0.01, time_limit=200))

        self.action_list.append(MoveTo(self.target_func_place_xy, 'gripper_close', error_limit=0.01, time_limit=200))
        self.action_list.append(MoveTo(self.target_func_place_z, 'gripper_close', error_limit=0.01, time_limit=200))
        self.action_list.append(MoveTo(self.target_func_place_z, 'gripper_open', error_limit=0.01, time_limit=200))
